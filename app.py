...
LESSON_DATA = {
    "Lesson 1: Where Are You From?": [
        {"target": "about", "desc": "[전치사] Talking or thinking of something. (무언가에 대해 말하거나 생각하는 것)"},
        {"target": "This book is about animals.", "desc": "[예문]"},
        {"target": "beautiful", "desc": "[형용사] Very pretty to look at or hear. (보거나 듣기에 매우 예쁜)"},
        {"target": "Look at the beautiful flower.", "desc": "[예문]"},
        {"target": "country", "desc": "[명사] A large land where people live together with their own rules. (사람들이 자신만의 규칙을 가지고 함께 사는 큰 땅)"},
        {"target": "I am from a beautiful country, Korea.", "desc": "[예문]"},
        {"target": "cousin", "desc": "[명사] The child of your aunt or uncle. (당신의 이모, 고모, 삼촌의 아이)"},
        {"target": "My cousin is 10 years old.", "desc": "[예문]"},
        {"target": "from", "desc": "[전치사] Starting at a place. (어떤 장소에서 시작하는)"},
        {"target": "Where are you from? I am from Canada.", "desc": "[예문]"},
        {"target": "guy", "desc": "[명사] A man, or a group of people. (남자, 또는 사람들의 무리/여러분)"},
        {"target": "Hi, guys! Let's play soccer.", "desc": "[예문]"},
        {"target": "ride", "desc": "[동사] To sit on something and travel. (무언가에 앉아서 이동하다)"},
        {"target": "I want to ride a bike.", "desc": "[예문]"},
        {"target": "team", "desc": "[명사] A group of people who play or work together. (함께 놀거나 일하는 사람들의 모임)"},
        {"target": "We are a good soccer team.", "desc": "[예문]"},
        {"target": "together", "desc": "[부사] With each other. (서로와 함께)"},
        {"target": "Let's study English together.", "desc": "[예문]"},
        {"target": "well", "desc": "[부사] In a good way. (좋은 방식으로/잘)"},
        {"target": "You speak English very well.", "desc": "[예문]"},
        {"target": "Korea", "desc": "[명사] A beautiful country in Asia. (아시아에 있는 아름다운 나라)"},
        {"target": "I live in Korea.", "desc": "[예문]"},
        {"target": "Canada", "desc": "[명사] A large country in North America. (북아메리카에 있는 큰 나라)"},
        {"target": "He is from Canada.", "desc": "[예문]"},
        {"target": "Vietnam", "desc": "[명사] A country in Southeast Asia. (동남아시아에 있는 나라)"},
...
def login_page():
    ...
    with col2:
        ...
        c_name = st.selectbox("몇 반인가요?", ["5학년 1반", "5학년 2반", "5학년 3반"])
...
def teacher_dashboard():
    ...
    t_class = st.selectbox("반을 선택해주세요:", ["5학년 1반", "5학년 2반", "5학년 3반"])
    st.write("---")
